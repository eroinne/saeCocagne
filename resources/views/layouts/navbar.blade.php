      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          ...
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            ...
            @else
                <a href="{{ route('home') }}" class="inline-flex items-center border-b-2 {{ $routeName == 'home' ? 'border-indigo-500' : 'border-transparent' }} px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700" >Accueil</a>
            @endif
        ...
        @if(Auth::check())
            ...
            <div class="relative ml-3" x-data="{open: false}" @mousedown.outside='open= false'>
                <div>
                <button x-on:click='open = !open' type="button" class="flex rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
        ...
        <div class="-mr-2 flex items-center sm:hidden" >
          <!-- Mobile menu button -->
          <button x-on:click="openMenu= !openMenu" type="button" class="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-controls="mobile-menu" aria-expanded="false">
