...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('depot', function (Blueprint $table) {
            ...
            $table->string('mail', 255)->nullable()->cascadeOnDelete();
            $table->string('siteWeb', 255)->nullable()->cascadeOnDelete();
            $table->string('nom_referent', 255);
            ...
            $table->string('text_presentation', 255)->nullable()->cascadeOnDelete();
            $table->string('chemin_image', 255)->nullable()->cascadeOnDelete();
            $table->string('commentaire', 255)->nullable()->cascadeOnDelete();
            $table->timestamps();
        });
    }
